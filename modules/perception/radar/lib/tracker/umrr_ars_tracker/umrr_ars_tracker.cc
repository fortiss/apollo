 ...
 *****************************************************************************/
#include "modules/perception/radar/lib/tracker/umrr_ars_tracker/umrr_ars_tracker.h"

namespace apollo {
namespace perception {
namespace radar {

double UmrrArsTracker::s_tracking_time_win_ = 0.06;
UmrrArsTracker::UmrrArsTracker()
    : BaseTracker(), matcher_(nullptr), track_manager_(nullptr) {
  name_ = "UmrrArsTracker";
}
...
bool UmrrArsTracker::Track(const base::Frame &detected_frame,
...
void UmrrArsTracker::TrackObjects(const base::Frame &radar_frame) {
...
void UmrrArsTracker::UpdateAssignedTracks(
...
void UmrrArsTracker::UpdateUnassignedTracks(
...
void UmrrArsTracker::DeleteLostTracks() { track_manager_->RemoveLostTracks(); }

void UmrrArsTracker::CreateNewTracks(
    const base::Frame &radar_frame,
...
void UmrrArsTracker::CollectTrackedFrame(base::FramePtr tracked_frame) {
...
PERCEPTION_REGISTER_TRACKER(UmrrArsTracker);
