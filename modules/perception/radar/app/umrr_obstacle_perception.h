...
namespace radar {
class UmrrObstaclePerception : public UmrrBaseRadarObstaclePerception {
 public:
  UmrrObstaclePerception() {}
  virtual ~UmrrObstaclePerception() {}

  bool Init(const std::string& pipeline_name) override;

  bool Perceive(const drivers::UmrrRadar& corrected_obstacles,
 ...
 private:
  std::shared_ptr<UmrrBaseDetector> detector_;
