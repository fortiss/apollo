...
bool UmrrObstaclePerception::Init(const std::string& pipeline_name) {
  ...
  UmrrBaseDetector* detector =
      UmrrBaseDetectorRegisterer::GetInstanceByName(detector_name);
...
bool UmrrObstaclePerception::Perceive(
...
std::string UmrrObstaclePerception::Name() const {
  return "UmrrObstaclePerception";
}

PERCEPTION_REGISTER_RADAR_OBSTACLE_PERCEPTION(UmrrObstaclePerception);
