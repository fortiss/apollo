...
class cspSendVersion2:
    ...
    def buildMessageDict(cls, sectionName, paramName, parameters, value, element, msgType, deviceId):
        ...
        if type(paramName) is list:
            ...
            for parameter in paramName:
                ...
                # add instruction
                param['instructionsList'].append(cls.addInstruction(paramDict, value, msgType, dim0, dim1, param['numberOfInstructions'] ))
        ...
        # work on single parameter tool
                ...
                # add instruction
                param['instructionsList'].append(cls.addInstruction(paramDict, value, msgType, dim0, dim1, 0))
    ...
    # ---------------------------------------------------------------------------------------------------------------- #
    @classmethod
    def addInstruction(cls, paramDict, value, msgType, dim0, dim1, instIdx):
        """
        ...
        instruction["parameterNumber"]  = paramDict["id"]
